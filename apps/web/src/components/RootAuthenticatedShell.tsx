...
import { AnchoredToastProvider, ToastProvider, toastManager } from "./ui/toast";
...
export function RootAuthenticatedShell() {
...
export function RootAuthenticatedShellError(props: { error: unknown; reset: () => void }) {
